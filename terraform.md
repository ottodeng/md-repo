...
<pre class=" language-bash"><code class="prism  language-bash"><span class="token function">wget</span> https://dl.google.com/go/go1.10.1.linux-amd64.tar.gz
...
<pre class=" language-bash"><code class="prism  language-bash"><span class="token function">wget</span> https://releases.hashicorp.com/terraform/0.11.7/terraform_0.11.7_linux_amd64.zip
...
<pre class=" language-bash"><code class="prism  language-bash">root@terraform:~/terraform/lab-k8sz1-tf<span class="token comment"># ls</span>
data_sources.tf k8s.tf terraform.tfvars variables.tf
</code></pre>
<p><code>data_sources.tf</code><br>
存放vsphere已有的资源变量</p>
<pre class=" language-tcl"><code class="prism  language-tcl">data <span class="token string">"vsphere_datacenter"</span> <span class="token string">"datacenter"</span> <span class="token punctuation">{</span>
...
<pre class=" language-tcl"><code class="prism  language-tcl"><span class="token comment"># vCenter connection</span>
...
<pre class=" language-shell"><code class="prism  language-shell">root@terraform:~/terraform# terraform init
...
<pre class=" language-shell"><code class="prism  language-shell">root@terraform:~/terraform# terraform plan
